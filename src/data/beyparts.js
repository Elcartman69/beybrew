...
const ASSIST_BLADES = [
  ...
  },
  {
    ...
    defense: 13,
    stamina: 10,
    image: "AssistBladeDual_Upper_Mode.webp",
  },
  {
    name: "Dual",
...
const parts = {
  blades: [
    ...
    },
    {
      ...
      type: "attack",
      spinType: "left",
      image: "X_Random_Booster_Lightning_L-Drago_1-60F_Rapid_Hit_Mode.webp",
    },
    {
      name: "L-Drago (upper mode)",
      points: 1,
      attack: 55,
      defense: 25,
      stamina: 20,
      type: "attack",
      spinType: "left",
      image: "X_Random_Booster_Lightning_L-Drago_1-60F_Upper_Mode.webp",
    },
    {
      name: "Black Shell",
      points: 1,
  ...
  ratchets: [
    {
      name: "Operate (Ratchet Integrated Bit)",
      altname: "",
      points: 0,
      attack: 0,
      defense: 0,
  ...
  bits: [
    ...
    {
      name: "Turbo",
      altname: "Turbo Sharp (Mode Change)",
      alias: "Tr",
      points: 1,
      attack: 30,
      defense: 30,
    ...
    {
      name: "Operate",
      altname: "Operate Sharp (Mode Change)",
      alias: "Op",
      points: 1,
      attack: 20,
      defense: 50,
...
parts.blades = [...parts.blades, ...BX_BLADES, ...UX_BLADES, ...CX_BLADES];
parts.assist_blades = [...parts.assist_blades, ...ASSIST_BLADES];
